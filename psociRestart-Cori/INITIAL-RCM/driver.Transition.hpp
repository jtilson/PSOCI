...
#include "PsociGAbasis.hpp"
  ...
  const string PSOCI_VERSION ="1.6";
...
// Subspace optimization parameters
   ...
   double final_rtol = 0.1 * MIN_PRECISION; // From PsociGAbasis: Tighter than this causes linear dependancies
...
// Basis filename information
   ...
   string configs2_filename = "configs2.test";
...
// Local per node data
  const unsigned long heap = 4L * 1024L * 1024L, stack = 2L * 1024L * 1024L ;
