...
//  GA::GlobalArray * local_vec = local_g_v;
  ...
  */
  ...
  GA::SERVICES.sync(); // Important ! - the solution process can result in cores going rogue.
...
//if ( GA::nodeid() == 0 ) cout << "at rnormSIngle" << endl;
  int numSoughtRoots = local_vector_set->CurrentNumSoughtRoots();
...
//assemble distributed rnorm
  ...
  //cout << "more crap rnorm " << rnormvec << endl;
